...
This project is indexed by GitNexus as **plannotator** (11517 symbols, 18067 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
